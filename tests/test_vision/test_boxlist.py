...
class TestBoxList:
    def setup_class(self):
        self.bl1 = BoxList([[30, 30, 50, 50], [40, 40, 80, 99]], (100, 100), device=torch.device('cuda:0'))
        self.bl2 = BoxList([[40, 40, 60, 80], [0, 0, 100, 100]], (100, 100), device=torch.device('cuda:0'))
